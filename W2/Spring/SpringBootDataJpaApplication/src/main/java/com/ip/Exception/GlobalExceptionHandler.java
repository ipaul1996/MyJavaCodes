...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> studentExceptionHandler(StudentException se, 
			WebRequest wr) {
	...
	public ResponseEntity<ErrorDetails> noHandlerFoundExceptionHandler
				(NoHandlerFoundException ne, WebRequest wr) {
		ErrorDetails ed = new ErrorDetails(LocalDateTime.now(), 
